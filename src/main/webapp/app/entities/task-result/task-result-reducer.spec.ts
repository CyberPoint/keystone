...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TASKRESULT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TASKRESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TASKRESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TASKRESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TASKRESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TASKRESULT actions', async () => {
      const expectedActions = [
        {

...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './registration-secret.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REGISTRATIONSECRET_LIST actions', async () => {
    ...
    it('dispatches FETCH_REGISTRATIONSECRET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REGISTRATIONSECRET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REGISTRATIONSECRET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REGISTRATIONSECRET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REGISTRATIONSECRET actions', async () => {
      const expectedActions = [
        {

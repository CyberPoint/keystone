...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './agent.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_AGENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AGENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AGENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AGENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AGENT actions', async () => {
      const expectedActions = [
        {

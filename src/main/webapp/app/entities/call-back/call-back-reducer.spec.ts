...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './call-back.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CALLBACK_LIST actions', async () => {
    ...
    it('dispatches FETCH_CALLBACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CALLBACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CALLBACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CALLBACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CALLBACK actions', async () => {
      const expectedActions = [
        {

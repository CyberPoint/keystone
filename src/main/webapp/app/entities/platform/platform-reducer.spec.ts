...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './platform.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLATFORM_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLATFORM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLATFORM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLATFORM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLATFORM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLATFORM actions', async () => {
      const expectedActions = [
        {

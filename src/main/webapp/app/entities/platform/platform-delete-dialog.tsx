...
export const PlatformDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(platformEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="keyStoneApp.platform.delete.question">
        <Translate contentKey="keyStoneApp.platform.delete.question" interpolate={{ id: platformEntity.id }}>
...
export default PlatformDeleteDialog;

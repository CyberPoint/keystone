...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './registration-event.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REGISTRATIONEVENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_REGISTRATIONEVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REGISTRATIONEVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REGISTRATIONEVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REGISTRATIONEVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REGISTRATIONEVENT actions', async () => {
      const expectedActions = [
        {

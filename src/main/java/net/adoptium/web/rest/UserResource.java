...
import net.adoptium.service.MailService;
import net.adoptium.service.UserService;
import net.adoptium.service.dto.AdminUserDTO;
import net.adoptium.web.rest.errors.BadRequestAlertException;
import net.adoptium.web.rest.errors.EmailAlreadyUsedException;
import net.adoptium.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link net.adoptium.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
